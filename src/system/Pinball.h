...
#define MENUFONT "src/user/resources/fonts/Baldur_96_768.png"
#define MENUSWORD "src/user/resources/textures/MenuSword.png"
...
#define SOUNDFANTASYMUSIC "src/user/resources/sound/fantasymusic.mp3"
#define SOUNDMAINTHEME "src/user/resources/sound/maintheme.mp3"
#define SOUNDMENUTHEME "src/user/resources/sound/menutheme.mp3"
#define SOUNDSWORDCUT "src/user/resources/sound/swordcut.mp3"
#define SOUNDTORCHES "src/user/resources/sound/torches.mp3"
